        ...
        slivers: [
              ...
              title: Text(
                ...
                style: GoogleFonts.poppins(
                  ...
                  color:
                      isDarkMode
                          ? Colors.white
                          : const Color.fromARGB(191, 0, 0, 0),
                ),
              ),
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              const SizedBox(height: 16),
              // Theme Settings
              _buildSectionHeader(context, 'Appearance', MdiIcons.palette),
              _buildCard(
                context,
              ...
              _buildSectionHeader(context, 'Notifications', MdiIcons.bell),
              _buildCard(
                context,
              ...
              _buildCard(
                ...
                child: ListTile(
                  ...
                  subtitle: const Text('Customize how often you get reminders'),
                  trailing: Icon(
                    Icons.arrow_forward_ios,
                    size: 16,
                    color: _getIconColor(context),
                  ),
                  leading: Icon(MdiIcons.timer, color: _getIconColor(context)),
                  onTap: () {
                    HapticFeedback.lightImpact();
              ...
              _buildCard(
                ...
                child: ListTile(
                  ...
                  subtitle: const Text('Secure your data with cloud backup'),
                  trailing: Icon(
                    Icons.arrow_forward_ios,
                    size: 16,
                    color: _getIconColor(context),
